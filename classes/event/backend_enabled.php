...
/**
 * Event for when a backend is enabled.
 *
...
use context_system;
use core\event\base;
use quiz_datawarehouse\backend;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backend_enabled extends base {
     ...
     *
     * @param \quiz_datawarehouse\backend $backend Quiz data warehouse backend.
     * @param context_system $context Context system.
     * @return base
     */
    public static function create_strict(\quiz_datawarehouse\backend $backend, context_system $context) : base {
        global $USER;
        $tid = $backend->get('id');
    ...
    public static function get_name() {
        return get_string('event:backendenabled', 'quiz_datawarehouse');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/quiz/report/datawarehouse/backend.php', $params);
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has enabled a backend with id '$this->objectid'.";
    }
