 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backend_created extends base {
    ...
    public static function get_name() {
        return get_string('event:backendcreated', 'quiz_datawarehouse');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created a backend with id '$this->objectid'.";
    }
