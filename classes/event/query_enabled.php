...
/**
 * Event for when a query is enabled.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class query_enabled extends base {
    ...
    public static function get_name() {
        return get_string('event:queryenabled', 'quiz_datawarehouse');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/quiz/report/datawarehouse/query.php', $params);
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has enabled a query with id '$this->objectid'.";
    }
