...
/**
 * Event for when a backend is deleted.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backend_deleted extends base {
    ...
    public static function get_name() {
        return get_string('event:backenddeleted', 'quiz_datawarehouse');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/quiz/report/datawarehouse/backend.php');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has deleted a backend with id '$this->objectid'.";
    }
