...
use quiz_datawarehouse\query_controller;
...
class query_list extends \flexible_table {
     ...
     * Display name column.
     *
     * @param \quiz_datawarehouse\query $data Query for this row.
     * @return string
     */
     ...
     *
     * @param \quiz_datawarehouse\query[] $records An array with records.
     */
