...
/**
 * Entity model representing query settings for the data warehouse quiz report.
 *
...
class query extends persistent {
    ...
    protected function validate_query(string $query) {
        if (helper::is_valid_quiz_datawarehouse_query($query)) {
            return true;
        } else {
            return new \lang_string('invalidquery', 'quiz_datawarehouse');
        }
    }
